...
class ParsedConfiguration {
  ...
  final List<ConfigEntry> reportLog;
  ...
  factory ParsedConfiguration.fromJson(
    ...
    final reportLogList = json['report_log'] as List<dynamic>? ?? [];
  ...
  /// 获取第一个可用的日志上报 URL
  String? get firstReportLogUrl {
    return reportLog.isNotEmpty ? reportLog.first.url : null;
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'report_log': reportLog.map((e) => e.toJson()).toList(),
