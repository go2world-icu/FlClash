...
class UpdateService {
  ...
  Future<Map<String, dynamic>> _checkForUpdatesFromUrl(String serverUrl) async {
    ...
    final dio = Dio();
    final requestUrl = '$serverUrl/api/v1/v2b/version/latest?version=$currentVersion&platform=$platform';
    ...
    return {
      ...
      "latestVersion": responseData["version"]?.toString() ?? "",
      "hasUpdate": responseData["has_update"] == true,
