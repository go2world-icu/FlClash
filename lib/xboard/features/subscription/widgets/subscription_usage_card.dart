...
class SubscriptionUsageCard extends ConsumerWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (progress >= 0.8 || remainingDays < 10) ...[
            const SizedBox(height: 12),
            _buildRenewExtendButton(theme, context),
          ],
        ],
      ),
    );
  ...
  Widget _buildRenewExtendButton(ThemeData theme, BuildContext context) {
    final panelUrl = XBoardConfig.panelUrl;
    return SizedBox(
      width: double.infinity,
      child: OutlinedButton.icon(
        onPressed: panelUrl != null
            ? () async {
