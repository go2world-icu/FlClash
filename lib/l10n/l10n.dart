...
class AppLocalizations {
  ...
  /// `Running time: {time}`
  String xboardRunningTime(Object time) {
    return Intl.message(
      'Running time: $time',
  ...
  String subscriptionExpiredDetail(Object date) {
    return Intl.message(
      'Plan expired on $date, please renew to continue using',
  ...
  String subscriptionExpiringInDaysDetail(Object days) {
    return Intl.message(
      'Plan will expire in $days days, please renew in time',
  ...
  String subscriptionValidDetail(Object days) {
    return Intl.message(
      'Subscription will expire in $days days',
  ...
  String registrationFailed(Object e) {
    return Intl.message(
      'Registration failed: $e',
  ...
  String sendVerificationCodeFailed(Object e) {
    return Intl.message(
      'Failed to send verification code: $e',
  ...
  String currentCommissionRate(Object rate) {
    return Intl.message(
      'Current commission rate: $rate%',
  ...
  String withdrawableAmount(Object amount) {
    return Intl.message(
      'Withdrawable amount: $amount',
  ...
  String maxTransferable(Object amount) {
    return Intl.message(
      'Max transferable: ¥$amount',
  ...
  String transferAmountExceeded(Object amount) {
    return Intl.message(
      'Transfer amount cannot exceed ¥$amount',
  ...
  String transferSuccessMsg(Object amount) {
    return Intl.message(
      'Transfer success! Transferred ¥$amount to wallet',
  ...
  String transferFailed(Object error) {
    return Intl.message(
      'Transfer failed: $error',
      name: 'transferFailed',
      desc: '',
  ...
  /// `Order: {orderNo}`
  String orderNumber(Object orderNo) {
    return Intl.message(
      'Order: $orderNo',
      name: 'orderNumber',
      desc: '',
  ...
  /// `Order amount: {amount}`
  String orderAmount(Object amount) {
    return Intl.message(
      'Order amount: $amount',
      name: 'orderAmount',
      desc: '',
  ...
  String updateCheckForceUpdate(Object version) {
    return Intl.message(
      'Force update: $version',
  ...
  String updateCheckNewVersionFound(Object version) {
    return Intl.message(
      'New version found: $version',
  ...
  String updateCheckCurrentVersion(Object version) {
    return Intl.message(
      'Current version: $version',
  ...
  String updateCheckServerError(Object statusCode) {
    return Intl.message(
      'Server returned error status code $statusCode',
  ...
  String onlineSupportSelectImagesFailed(Object error) {
    return Intl.message(
      'Failed to select images: $error',
  ...
  /// `Upload failed: {error}`
  String onlineSupportUploadFailed(Object error) {
    return Intl.message(
      'Upload failed: $error',
  ...
  String onlineSupportUnsupportedHttpMethod(Object method) {
    return Intl.message(
      'Unsupported HTTP method: $method',
  ...
  String onlineSupportGetMessagesFailed(Object statusCode) {
    return Intl.message(
      'Failed to get messages: $statusCode',
