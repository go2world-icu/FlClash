...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(error) => "Logout failed: ${error}";

  static String m19(amount) => "Max transferable: ¥${amount}";
  ...
  static String m24(statusCode) => "Failed to get messages: ${statusCode}";

  static String m25(error) => "Failed to select images: ${error}";

  static String m26(method) => "Unsupported HTTP method: ${method}";

  static String m27(error) => "Upload failed: ${error}";

  static String m28(amount) => "Order amount: ${amount}";

  static String m29(orderNo) => "Order: ${orderNo}";

  static String m30(page) => "Page ${page}";

  static String m31(label) => "${label} must be between 1024 and 49151";

  static String m32(e) => "Registration failed: ${e}";

  static String m33(count) => "${count} seconds";

  static String m34(count) => "${count} items have been selected";

  static String m35(e) => "Failed to send verification code: ${e}";
  ...
  static String m38(days) => "Subscription will expire in ${days} days";

  static String m39(count) => "Total ${count} records";

  static String m40(amount) => "Transfer amount cannot exceed ¥${amount}";

  static String m41(error) => "Transfer failed: ${error}";

  static String m42(amount) =>
      "Transfer success! Transferred ¥${amount} to wallet";

  static String m43(version) => "Current version: ${version}";

  static String m44(version) => "Force update: ${version}";

  static String m45(version) => "New version found: ${version}";

  static String m46(statusCode) =>
  ...
  static String m49(amount) => "Withdrawable amount: ${amount}";
