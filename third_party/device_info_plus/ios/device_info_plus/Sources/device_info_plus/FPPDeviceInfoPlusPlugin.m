...
// FlClash patch: isiOSAppOnVision requires the iOS 26.1 SDK; guard at compile
// time so the plugin still builds with older Xcode toolchains.
#if defined(__IPHONE_26_1) && __IPHONE_OS_VERSION_MAX_ALLOWED >= 260100
